        ...
        <div className="col-span-2">
          <Card>
            ...
            <Card.Content className="flex flex-col gap-4">
              <TextField
                label="Промпт"
                value="Космонавт в мультипликационном стиле"
                required
                placeholder="Prompt"
              />
              <div>
                  ...
                  <TooltipProvider>
                    <Tooltip delayDuration={100}>
                      ...
                      <TooltipContent className="p-2 max-w-[240px] text-sm">
                        <img className="mb-1 w-full aspect-square rounded-md" src="https://interactiveimmersive.io/wp-content/uploads/2022/11/cjow_portrait_of_a_warrior_women_with_feathers_in_her_hair_d2c69ea7-3f50-42e7-8b43-c0ce2868e539.png" />
